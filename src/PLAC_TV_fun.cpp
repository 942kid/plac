...
// [[Rcpp::export]]
MatrixXd TvInd1(Map<VectorXd> Zv, Map<ArrayXd> W){
...
// [[Rcpp::export]]
MatrixXd BetaTv2(Map<MatrixXd> ZFV_,
                 Map<MatrixXd> Z,
                 Map<MatrixXd> X, 
                 Map<MatrixXd> Ind1,
                 Map<MatrixXd> Ind2,
...
// [[Rcpp::export]]
VectorXd LambdaTv2(Map<MatrixXd> Z,
                Map<MatrixXd> X, 
                Map<MatrixXd> Ind1,
                Map<MatrixXd> Ind2,
                Map<ArrayXd> Dn,
...
// [[Rcpp::export]]
MatrixXd SWE_Tv2(Map<MatrixXd> ZFV_,
                 Map<MatrixXd> Z,
                 Map<MatrixXd> X,
                 Map<ArrayXd> W,
                 Map<MatrixXd> Ind1,
